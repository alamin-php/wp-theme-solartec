<?php get_header(); ?>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo get_template_directory_uri(  ); ?>/assets/img/carousel-1.jpg'>">
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo get_template_directory_uri(  ); ?>/assets/img/carousel-2.jpg'>">
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo get_template_directory_uri(  ); ?>/assets/img/carousel-3.jpg'>">
                <img class="img-fluid" src="<?php echo get_template_directory_uri(  ); ?>/assets/img/carousel-3.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
